  ...
  _createClass(Client, [{
    ...
    value: function getTeamsAtWeek(_ref5) {
      ...
      return axios__WEBPACK_IMPORTED_MODULE_4___default.a.get(route, this._buildAxiosConfig()).then(function (response) {
        ...
        var members = lodash_get__WEBPACK_IMPORTED_MODULE_3___default()(response.data, 'members');

        var data = teams.map(function (item, i) {
          return _objectSpread(_objectSpread({}, members[i]), item);
        });
