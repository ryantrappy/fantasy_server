...
var Client = /*#__PURE__*/function () {
  ...
  _createClass(Client, [{
    ...
    value: function getTeamsAtWeek(_ref5) {
      ...
      return axios__WEBPACK_IMPORTED_MODULE_4___default.a.get(route, this._buildAxiosConfig()).then(function (response) {
        var teams = lodash_get__WEBPACK_IMPORTED_MODULE_3___default()(response.data, 'teams');

        var members = lodash_get__WEBPACK_IMPORTED_MODULE_3___default()(response.data, 'members'); // const data = teams.map(item => Object.assign({ item, members.find(y => y.id == item.primaryOwner) }));


        var result = teams.map(function (obj) {
          var data = members.find(function (item) {
            return item.id === obj.primaryOwner;
          });
          return _objectSpread(_objectSpread({}, data), obj);
        });
        return lodash_map__WEBPACK_IMPORTED_MODULE_1___default()(result, function (team) {
